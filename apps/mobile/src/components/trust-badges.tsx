...
export function TrustBadges({
  ...
  const badges = [
    realPersonVerified
      ? { key: "person", label: rtl ? "شخص حقيقي موثّق" : "Real person verified" }
      : null,
    age18PlusVerified
      ? { key: "age", label: rtl ? "العمر 18+ موثّق" : "18+ verified" }
      : null,
    identityVerified
      ? { key: "identity", label: rtl ? "الهوية موثّقة" : "Identity verified" }
      : null,
