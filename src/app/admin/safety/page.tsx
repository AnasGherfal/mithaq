    ...
    <main className="px-5 py-8 sm:px-8 sm:py-10">
      <div className="mx-auto w-full max-w-7xl">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-7 text-black/50">
              هذا الطابور يعرض بيانات البلاغ اللازمة للتحقيق فقط. لا يعرض أرقام
              الهواتف أو بيانات تسجيل الدخول، وكل انتقال حالة يُسجل في سجل
              الإشراف.
            </p>
          </div>
        ...
        <section className="mt-6 rounded-[1.75rem] border border-amber-200 bg-amber-50 p-5 text-sm leading-7 text-amber-900">
          <strong>ملاحظة تشغيلية:</strong> هذه الصفحة لإدارة حالة البلاغ فقط.
          تعليق الحساب أو حظره إدارياً سيكون في شاشة تنفيذ منفصلة بتأكيد أقوى
          حتى لا يحدث إجراء خطير بالخطأ.
        </section>
            ...
            return (
              ...
              >
                <div className="flex flex-wrap items-start justify-between gap-4">
                  ...
                  <div className="text-xs leading-6 font-bold text-black/40">
                  ...
                  <div className="mt-5 space-y-4">
                    <div className="grid gap-3 sm:grid-cols-2">
                      ...
                      <div className="rounded-2xl bg-[#f8f5ef] p-4">
                        ...
                        <div className="mt-1 text-sm font-black text-[#153d35]">
                          {report.reporterDisplayName ?? "عضو"}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-red-100 bg-red-50/40 p-4">
                      ...
                      <p className="mt-2 text-sm leading-7 whitespace-pre-line text-black/65">
                        {report.details || "لم يضف المستخدم تفاصيل نصية."}
                      </p>
                    </div>

                    <div className="text-xs font-bold text-black/38">
                      أُرسل: {formatDate(report.reportedAt)}
                    </div>
                  </div>
                ) : (
                ...
                {actions.length && report ? (
                  <form
                    action={moderateSafetyReport}
                    className="mt-5 space-y-3 border-t border-black/7 pt-4"
                  >
                    <input
                      name="report_id"
                      type="hidden"
          ...
          {reports.length === 0 ? (
            <div className="rounded-3xl border border-dashed border-black/15 bg-white p-12 text-center xl:col-span-2">
              ...
              <p className="mt-2 text-sm text-black/42">
                ستظهر هنا البلاغات الجديدة والتي ما زالت تحت الفرز أو التحقيق.
              </p>
            </div>
          ) : null}
        </div>
