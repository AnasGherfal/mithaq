  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
      <div className="max-w-3xl">
        ...
        <h1 className="mt-4 text-4xl font-bold tracking-tight text-balance sm:text-5xl">{t("title")}</h1>
      ...
      <Button variant="outline" className="mt-8" asChild>
        <Link href="/">{t("back")}<ArrowRight className="rtl:rotate-180" aria-hidden="true" /></Link>
      </Button>
    </main>
  );
}
