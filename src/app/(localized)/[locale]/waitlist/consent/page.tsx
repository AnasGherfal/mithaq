  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <form
        ...
        className="mt-8 space-y-5 rounded-3xl border border-primary/15 bg-card p-6 sm:p-8"
      >
        ...
        <div className="text-sm text-muted-foreground">
          <a className="underline underline-offset-4" href={`/${lang}/terms`}>
            Terms
          </a>
          <span aria-hidden="true"> · </span>
          <a className="underline underline-offset-4" href={`/${lang}/privacy`}>
            Privacy
          </a>
        </div>
        <button
          className="min-h-12 w-full rounded-xl bg-primary px-5 font-semibold text-primary-foreground hover:bg-primary/90"
          type="submit"
        >
          {copy.submit}
        </button>
